...
enum Flavor { DEVELOPMENT, STAGING, UAT, PRODUCTION }
...
class BuildConfig {
  ...
  static String flavorName() => StringUtils.enumToName(_instance.flavor.toString());

  static bool isRelease() => _instance.flavor == Flavor.PRODUCTION;

  static bool isProduction() => _instance.flavor == Flavor.UAT;
